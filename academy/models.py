...
class Student(models.Model):
    ...
    course_enrolled_in = models.ManyToManyField('Course',blank=True)  # Many-to-Many relationship for courses
...
class Footer(models.Model):
    ...
    # our_courses = models.ForeignKey(Course, on_delete=models.CASCADE)
...
class Contact(models.Model):
    ...
    message = models.TextField(blank=True,null=True)  # Ye add kiya hai bhai 💪
